...
using Tyuiu.BozhukovVP.Sprint0.Task7.V0.Lib;
namespace Tyuiu.BozhukovVP.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 Выполнил: Божуков В. П. ИБКСб-24-1";
            Console.WriteLine("***************************************************************************");
            ...
            {
                Console.WriteLine("Ошибка! Исходные массивые имеют разное количество элементов");
            }
            Console.ReadKey();
        }
    }
